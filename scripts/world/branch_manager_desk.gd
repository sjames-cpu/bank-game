...
## press the interact key. Identical pattern to teller_desk.gd and
## loan_officer_desk.gd — this script only announces the interaction, it
## has no idea what should happen next or whether the desk is even usable
## yet. Whoever cares connects to the signal instead. See teller_room.gd,
## which also owns the is_branch_manager_unlocked gating for this desk.
